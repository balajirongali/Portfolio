...
const projects = [
  {
    ...
    gitlink: 'https://github.com/balajirongali/Attendance-Recorder'
  },
  {
  ...
  },
  {
    ...
    gitlink: 'https://github.com/balajirongali/NewsMonkey'
  },
  {
    ...
    gitlink: 'https://github.com/balajirongali/bank_management_system'
  },
      ...
      <div className="projects-grid">
        {projects.map((project, index) => (
          <div className="project-card" key={index}>
            ...
            <div>
            <button className='btn btn-primary'><a href={project.gitlink} className="project-link" target="_blank" rel="noopener noreferrer">Github</a></button>
            {project.link && (
            <button style={{margin:'4px'}} className='btn btn-success'>
